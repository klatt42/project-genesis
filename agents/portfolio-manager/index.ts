...
export class PortfolioManager {
  ...
  private dashboard: PortfolioDashboard;
   ...
   * List all projects
   */
  async listProjects(options?: { verbose?: boolean }): Promise<void> {
   ...
   */
  async showProjectDetails(projectIdOrName: string): Promise<void> {
    const projects = this.registry.getAllProjects();
    const project = projects.find(
      p => p.id === projectIdOrName || p.name.toLowerCase() === projectIdOrName.toLowerCase()
    );
   ...
   * Search projects
   */
  async searchProjects(criteria: ProjectSearchCriteria): Promise<void> {
   ...
   */
  async updateHealth(projectId: string): Promise<void> {
   ...
   */
  async exportPortfolio(outputPath: string): Promise<void> {
   ...
   */
  async importPortfolio(inputPath: string, merge: boolean = false): Promise<void> {
