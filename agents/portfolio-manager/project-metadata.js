...
export class ProjectMetadataManager {
     ...
     */
    calculateStatistics(projects, relationships) {
        const stats = {
    ...
    calculateHealth(projects) {
        ...
        const totalWeight = health.healthy * healthyWeight +
     ...
     */
    findSimilarProjects(targetProject, allProjects, threshold = 0.5) {
        const results = [];
    ...
    calculateSimilarity(project1, project2) {
        ...
        maxScore += 2;
        if (project1.stack.framework === project2.stack.framework)
            score += 2;
        ...
        maxScore += 1;
        if (project1.stack.deployment === project2.stack.deployment)
            score += 1;
