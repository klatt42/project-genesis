...
export class MetricsAggregator {
     ...
     */
    aggregateMetrics(projectMetrics) {
     ...
     */
    aggregatePortfolioMetrics(projects) {
     ...
     */
    aggregateErrorMetrics(projects) {
     ...
     */
    aggregateAnalyticsMetrics(projects) {
     ...
     */
    aggregatePerformanceMetrics(projects) {
     ...
     */
    aggregateUptimeMetrics(projects) {
    ...
    calculateHealthScore(metrics) {
        ...
        const healthScore = (uptimeScore * 0.4 +
            errorScore * 0.3 +
